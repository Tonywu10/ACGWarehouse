...
public class MyMediaController extends MediaController{
    ...
    protected View makeControllerView() {
        View v = ((LayoutInflater) getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(getResources().getIdentifier("controller_my_media", "layout", getContext().getPackageName()), this);
