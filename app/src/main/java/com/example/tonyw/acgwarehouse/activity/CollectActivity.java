...
public class CollectActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private Handler mHandler=new Handler()
    {
        public void handleMessage(Message msg)
        {
            ...
            {
                case NO_NETWORK:
                    Toast.makeText(CollectActivity.this,"网络出错",Toast.LENGTH_SHORT).show();
                    mSwipeRefreshLayout.setRefreshing(false);
                    break;
                case NO_DATA_GET:
                    Toast.makeText(CollectActivity.this,"数据无法获取",Toast.LENGTH_SHORT).show();
                    mSwipeRefreshLayout.setRefreshing(false);
                    break;
                case IS_FINISH:
                    setDynamicPreView();
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        RecyclerView recyclerView = (RecyclerView)findViewById(R.id.collect_news_recyclerview);
        recyclerView.setRecycledViewPool(new RecyclerView.RecycledViewPool());
        recyclerView.setHasFixedSize(true);
        mSwipeRefreshLayout= (SwipeRefreshLayout)findViewById(R.id.news_collect_swipeRefresh);
        ...
        mCollectNewsAdapter =new CollectNewsAdapter(entityData,this);
