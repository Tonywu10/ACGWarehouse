...
public class SeriesDetailActivity extends AppCompatActivity{
    public static Activity seriesDetailActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WrappingGridLayoutManager gridLayoutManager=new WrappingGridLayoutManager(getApplicationContext(),DEFAULT_SPAN_COUNT);
